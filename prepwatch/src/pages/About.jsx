  ...
  return (
    <>
      <div className="h-screen overflow-hidden select-none bg-neutral-900 w-full text-rose-50 text-xl font-[Segoe-UI-Emoji] md:text-3xl">
        ...
        <div>
          <img src="https://static.boredpanda.com/blog/wp-content/uploads/2025/10/funny-cat-memes-go-hard-cover_675.jpg" alt="cat meme" className={`${selectinfo?"opacity-100":"opacity-0"} z-90 absolute left-[50%] top-[50%] w-[200px] md:w-[300px] rounded-lg  transition-opacity duration-300 ease-in-out`} />
        </div>
