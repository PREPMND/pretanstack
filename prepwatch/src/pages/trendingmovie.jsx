...
export default function TrendingMovie(props) {
    ...
    if (setl) return(<div className={`w-full min-h-[calc(100vh-120px)] h-full bg-neutral-900 z-40 flex items-center justify-center whitespace-nowrap text-yellow-50 font-[Inter] font-[600] `}>
            ...
            <div onClick={() => {
                ...
                setMovies(null);
                                    ...
                                    <div onClick={(e) => e.stopPropagation()}
                                        className="relative inset-0 w-[80%] md:w-[70%] ">
