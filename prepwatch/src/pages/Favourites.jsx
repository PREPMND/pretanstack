    ...
    return(
        ...
        <div>
            <div className="h-[calc(100vh-120px)] bg-neutral-900 ">
                ...
                <div>
                    <div>{localStorage.getItem("favourites") && JSON.parse(localStorage.getItem("favourites"))?.map((movie)=>{
                        return(
                            <div key={movie} className="flex items-center justify-between w-[90%] mx-auto mt-5 p-3 bg-neutral-800 rounded-lg">
