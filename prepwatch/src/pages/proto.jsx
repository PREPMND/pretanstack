...
import { fetchPopularMovies ,fetchTrending} from '../api/apiextra'
...
const Proto = (props) => {
  ...
  return (
    <div>
      ...
      <div>
        {GridLayout(navigate, trending, setselectedtrending,  movieHovered, setmovieHovered, favourites, setfavourites, heart, setheart)}
      </div>
    </div>
