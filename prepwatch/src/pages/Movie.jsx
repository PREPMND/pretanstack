import { fetchMovies } from "../api/apiextra.jsx"
    ...
    return (
        ...
        <>
            ...
            <div onClick={() => {
                ...
                <h2 className="text-white text-xl md:text-3xl  font-semibold absolute top-0 truncate m-auto mt-2 inset-0 w-full text-center" >{movies.title}</h2>
                <img
