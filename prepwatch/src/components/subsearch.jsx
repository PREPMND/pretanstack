                ...
                <div className={``} >
                    <div className='bg-neutral-900 pt-2 flex md:pt-2 pb-2 md:justify-center h-auto items-center '>
                        ...
                        <RotateCcw
                         ...
                         />
                        <div className={`${status==="Offline"?"block":"hidden"} text-rose-600 text-[8px]  md:text-sm right-24 absolute md:flex hidden`}><div className="">Looks like you're </div>Offline</div>
