...
export default function Navbar(props){
  ...
  >
    ...
    <div
      ...
      className="absolute top-0 ml-83  right-[0] h-screen bg-neutral-700 w-[60%] md:w-[40%] flex flex-col   gap-6 items-start transition-colors dur *:ml-2 pt-5 text-rose-50 rounded-l-3xl p-5 "
    >
