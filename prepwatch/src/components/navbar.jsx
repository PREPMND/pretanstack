...
export default function Navbar(props){
    ...
    return(
        ...
        items-center *:items-center text-white font-semibold'>
            ...
            <div>
                <div>
                    <button onClick={()=>navigate('/movie')} className='bg-emerald-800 active:scale-95 active:bg-emerald-500 px-2 py-1 rounded-md ml-4 mr-2 md:mr-0 active:text-slate-50 '>Movies</button>
                </div>
                <div>
