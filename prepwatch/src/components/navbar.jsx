...
export default function Navbar(props){
    ...
    return(
        <>
        <div className='flex *:flex h-[64px] bg-amber-400 w-full p-4 justify-between *:justify-between md:*:gap-4 *:gap-2
        ...
        {backdrop && <div className='absolute top-0 right-0  h-screen bg-neutral-900 z-50 flex flex-col items-center justify-center w-[60%] md:w-[40%] gap-4'>
            ...
            <button onClick={()=>navigate('/about')} className='bg-emerald-800 active:scale-95 active:bg-emerald-500 px-4 py-2 rounded-md active:text-slate-50'>About</button>
        </div>}
