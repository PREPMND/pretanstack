...
export default function Navbar(props){
  ...
  >
    ...
    <div
      ...
      className="absolute top-0 ml-3  right-[0] h-screen bg-neutral-700 w-[60%] md:w-[40%] flex flex-col hover:   gap-4 items-start *:ml-3 pt-5 text-rose-50 rounded-l-3xl p-5 "
    >
