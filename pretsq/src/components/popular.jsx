...
function Popular() {
  ...
  return (
    ...
    className="ml-3 mt-2 bg-amber-400 md:text-[15px] text-[12px] hover:bg-amber-300  text-neutral-900 font-semin px-2 py-1 rounded active:scale-95">Popular Movies</button>
