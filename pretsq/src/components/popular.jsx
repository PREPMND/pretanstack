...
function Popular() {
  ...
  return (
    ...
    <div className="grid grid-flow-col  auto-cols-[140px] md:auto-cols-[190px] gap-2 md:gap-4 overflow-y-hidden mt-3 scroll-smooth scrollbar-hide overflow-x-auto focus:ring-2 focus: px-3 ">
