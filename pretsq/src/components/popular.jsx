...
function Popular() {
  ...
  return (
    ...
    className="ml-3 mt-2 md:text-[15px] font-[600] text-[12px] bg-white/20 hover:bg-white/30 text-white  px-2 py-1 rounded active:scale-95">More Popular Movies</button>
