...
function Popular() {
  ...
  return (
    ...
    <button className="ml-3 mt-2 font-mono bg-amber-500 hover:bg-amber-200 hover:border-amber-500 px-2 py-1 rounded active:scale-95">Popular Movies</button>
    <button onClick={()=>setnum(prev=>prev+1)}
    className="ml-3 mt-2 font-mono hover:bg-amber-200 hover:border-amber-500 hover:text-ne bg-amber-500 px-2 py-1 rounded active:scale-95">More Popular Movies</button>
