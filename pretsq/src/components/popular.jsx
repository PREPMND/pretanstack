...
function Popular() {
  ...
  return (
    ...
    <div className="grid grid-flow-col select-none auto-cols-[140px] md:auto-cols-[180px] gap-2 md:gap-4 overflow-y-hidden mt-4 scroll-smooth scrollbar-hide overflow-x-auto focus:ring-2 focus:ring-amber-400 px-3 ">
