...
function Popular() {
  ...
  return (
    ...
    <button className="ml-3 mt-2 font-mono bg-amber-200 hover:bg-amber-200 hover:border-amber-200 text-neutral-900 px-2 py-1 rounded active:scale-95">Popular Movies</button>
