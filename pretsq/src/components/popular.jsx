...
function Popular() {
  ...
  return (
    ...
    <div className="grid grid-flow-col  auto-cols-[140px] md:auto-cols-[190px] gap-2 md:gap-3 overflow-y-hidden mt-3 overflow-x-auto ">
      {data?.slice(0, 10*num).map((movie) => (
        <div className=""
          key={movie.id}>
        <div className="w-full bg-neutral-900 aspect-[2/3] place-items-center"> 
          <img className='hover:scale-105 transition-transform duration-200 ease-in-out object-cover rounded h-full px-3'
