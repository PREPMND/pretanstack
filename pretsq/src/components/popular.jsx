...
function Popular() {
  ...
  return (
    ...
    <div className="grid grid-flow-col  auto-cols-[140px] md:auto-cols-[190px] gap-2 md:gap-4 overflow-y-hidden mt-3 scroll-smooth scrollbar- overflow-x-auto  px-3 ">
