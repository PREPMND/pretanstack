...
function Popular() {
  ...
  return (
    ...
    <div className="grid grid-flow-col auto-cols-[120px] md:auto-cols-[180px] gap-2 mt-3  overflow-y-hidden overflow-x-auto ">
      {data?.slice(0, 10*num).map((movie) => (
        <div className=""
          key={movie.id}>
        <div className="w-full aspect-[2/3] place-items-center"> 
          <img className='hover:scale-105 transition-transform duration-200 ease-in-out object-cover rounded object-top h-full'
