...
function Popular() {
  ...
  return (
    ...
    className="ml-3 mt-2 md:text-[15px] font-[500] text-[12px] hover:bg-amber-300 hover:border-amber-500 text-neutral-900 bg-amber-400 px-2 py-1 rounded active:scale-95">More Popular Movies</button>
