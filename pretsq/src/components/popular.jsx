...
function Popular() {
  ...
  return (
    ...
    className="ml-3 mt-2 bg-amber-400 md:text-[15px] text-[12px] hover:bg-amber-300  text-neutral-900 font-semibold px-2 py-1 rounded active:scale-95">Popular Movies</button>
    <button onClick={()=>setnum(prev=>prev+1)}
    className="ml-3 mt-2 md:text-[15px] font-[600] text-[12px] bg-white/20 hover:bg-white/30 text-white backdrop-blur-sm px-2 py-1 rounded active:scale-95">More Popular Movies</button>
