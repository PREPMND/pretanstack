...
function Popular() {
  ...
  return (
    ...
    <button className="ml-3 mt-2 font-mono bg-amber-400 hover:bg-amber-200 hover:border-amber-200 text-neutral-900 px-2 py-1 rounded active:scale-95">Popular Movies</button>
    <button onClick={()=>setnum(prev=>prev+1)}
    className="ml-3 mt-2 font-mono hover:bg-amber-200 hover:border-amber-500 text-neutral-900 bg-amber-400 px-2 py-1 rounded active:scale-95">More Popular Movies</button>
