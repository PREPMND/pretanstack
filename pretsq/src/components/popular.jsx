...
function Popular() {
  ...
  return (
    ...
    className="ml-3 mt-2 font-mono hover:bg-amber-200 hover:border-amber-500 text-neutral-900 bg-amber-300 px-2 py-1 rounded active:scale-95">More Popular Movies</button>
