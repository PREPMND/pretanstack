...
function Popular() {
  ...
  return (
    ...
    <div className="grid grid-flow-col bg-neutral-900 auto-cols-[140px] md:auto-cols-[190px] gap-2 md:gap-3 overflow-y-hidden overflow-x-auto ">
      {data?.slice(0, 10*num).map((movie) => (
        ...
        <div className="w-full bg-neutral-900 aspect-[2/3] place-items-center"> 
          ...
          <h3 className="truncate mt-[6px] pb-24 md:pb-1 font-mono font-semibold text-">{movie.title}</h3>
        </div>
