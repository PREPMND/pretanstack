        ...
        <div className='bg-neutral-900 mt-3 '>
            <div className='bg-neutral-900 flex justify-center flex-col w-full '>
                <button onClick={()=>navigate("/trending/movies")}
                    className="ml-3 mt-2 block mx-auto md:text-[18px] font-[600] text-[14px] bg-white/20 hover:bg-white/30 text-white backdrop-blur-sm px-[10px] py-[] rounded active:scale-95">Top Rated</button>
            </div>
