                ...
                {data?.slice(0, 19).map((movie) => (
                    <div className=""
                        ...
                        <div 
                            ...
                            className={`w-full relative bg-neutral-900 aspect-[2/3] overflow-hidden ${selected==movie.id ?"hidden":"flex"}`}
                        >
                            <img
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className={`bg-black/70 ${selected==movie.id ?"":"hover:bg-black"} px-4 py-2 rounded text-white text-sm flex items-center gap-2`}
                                >
