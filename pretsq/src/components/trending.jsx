        ...
        <div className='bg-neutral-900 mt-3 '>
            ...
            <div className="grid grid-flow-col select-none auto-cols-[140px] md:auto-cols-[190px] gap-2 md:gap-4 overflow-y-hidden mt-3 scroll-smooth scrollbar-hide overflow-x-auto focus:ring-2 focus:ring-amber-400 px-3 pt-2">
                {data?.slice(0, 19).map((movie) => (
                    <div className=""
                        key={movie.id}>
                        <div className="w-full relative z-30 bg-neutral-900 aspect-[2/3] place-items-center overflow-hidden">
                            <img 
                            ...
                            />
                            <div 
                            className={`absolute inset-0 z-30 ${movieHovered== movie.id?"flex":"hidden"} items-center justify-center text-white`}>Play</div>
                        </div>
                        <h3 className="truncate mt-[6px] md:pb-1 font-Inter font-semibold text-slate-50">{movie.id}</h3>
