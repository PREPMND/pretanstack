                ...
                {data?.slice(0, 19).map((movie) => (
                    <div className=""
                        ...
                        <div className="w-full z-30 bg-neutral-900 aspect-[2/3] place-items-center">
                            ...
                            />
                            <div 
                            className={`relative z-40 ${movieHovered==movie.id?"flex":"hidden"} items-center justify-center text-white`}>Play</div>
                        </div>
                        <h3 className="truncate mt-[6px] md:pb-1 font-Inter font-semibold text-slate-50">{`${movieHovered==movi?"yes":"no"}`}</h3>
