                    ...
                    <div className=""
                        ...
                        <div className="w-full relative bg-neutral-900 aspect-[2/3] overflow-hidden">
                            ...
                            className='hover:scale-105 z-10 transition-transform duration-200 ease-in-out object-cover rounded h-full '
                                ...
                                alt={movie.title}
                            />
                            <div onClick={() => setselected(movie)}
                            className={`absolute inset-0 z-20 ${movieHovered== movie.id?"flex":"hidden"} items-center justify-center text-white pointer-events-none text-[17px]`}><span className="text-red-500 pr-[3px]">▶  </span> Play</div>
                        </div>
