...
export default function IndvPopular(props){
    ...
    return(
        ...
        <div className="flex flex-col pl-3">
            ...
            <div className="aspect-[3/2] h-fit mt-1 flex justify-center overflow-hidden">
                  
                <img className="rounded-lg hover:scale-[1.02] transition-transform duration-200 ease-in-out object-cover h-[50%] w-[50%] object-cover "
