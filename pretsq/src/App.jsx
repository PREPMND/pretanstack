...
export default function App(){
    ...
    return(
        ...
        <BrowserRouter>
           ...
           <NavRoutes selectedtoprated={selectedtoprated} setselectedtoprated={setselectedtoprated} selectedtoprated={selectedtoprated} setselectedtoprated={setselectedtoprated}/>
